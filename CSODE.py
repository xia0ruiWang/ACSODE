...
if __name__ == "__main__":
    ...
    data_test = pd.read_csv(r"D:\pycharmproject\Augment node for PMSM\SPMSMzhengjieyue500qian.csv", header=None)
    ...
    model = CSNeuralODE(func=ODEFunc(),gfunc=ODEFuncG(2,device),input_dim=2).to(device)
